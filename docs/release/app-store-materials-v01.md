# Baohe v0.1 App Store Materials Boundary
...
- Support URL: `https://www.nesio.app/support`
- Privacy Policy URL: `https://www.nesio.app/privacy`

These URLs must exist before TestFlight public external testing or App Store submission.

## Do Not Promise

- 不承诺 AI 自动执行或 AI 助手能力。
- 不承诺心理、疗愈、诊断、治疗或情绪健康结果。
- 不承诺健康建议、医疗建议、训练处方或 Health 数据接入。
- 不承诺财务建议、账户连接、支付、账单、订阅或金融数据处理。
- 不承诺 10+ 工具全可用。
- 不承诺云同步、跨设备同步、外部授权或后台服务。
- 不承诺订阅、付费解锁、StoreKit、价格或恢复购买。
