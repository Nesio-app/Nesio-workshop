...
const KNOWN_KEYS = new Map([
  ...
  ["nesio-place-image-sync-since-v1", "cache"],
  ...
  ["nesio-reader-sync-since-v1", "cache"],
  ...
  ["nesio-wardrobe-image-sync-since-v1", "cache"],
  ["nesio-care-image-sync-state-v1", "cache"],
  ["nesio-care-image-sync-since-v1", "cache"],
  ...
  ["nesio-bank-recur-cadence-v1", "durable"],
