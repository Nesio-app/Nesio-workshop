...
const sourceChecks = [
  ...
  ['components/portal/PortalAiFriendsPreview.tsx', 'Gemini'],
  ['components/portal/PortalAiFriendsPreview.tsx', 'ChatGPT'],
  ['components/portal/PortalAiFriendsPreview.tsx', '豆包'],
  ['components/portal/PortalAiFriendsPreview.tsx', '群聊'],
  ['components/portal/PortalAiFriendsPreview.tsx', 'Live'],
  ['components/portal/ToolsTreasureSheet.tsx', '工具箱'],
  ['components/portal/ToolsTreasureSheet.tsx', '本周推荐'],
  ['components/portal/ToolsTreasureSheet.tsx', '我的工具'],
  ['components/portal/ToolsTreasureSheet.tsx', '数据深度'],
  ['components/portal/ToolsTreasureSheet.tsx', '越丰富，宝盒越懂你'],
