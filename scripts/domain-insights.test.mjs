...
{
  const mod = makeCtx({ hm: { glucose: [], sleepStages: [], metrics: [], profile: {} }, findings: FINDINGS, risks: RISKS, txs: [{ amount: 1 }], finance: FINANCE });
  ...
  assert.equal(insights.length, 6, '2 findings + 2 risks + 2 finance');
