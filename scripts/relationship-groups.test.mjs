...
function loadRel() {
  ...
  vm.runInNewContext(js, {
    ...
    window: undefined, require: (p) => (p.includes('storage-health') ? { reportStorageDropped: () => {} } : p.includes('entity-resolution') ? { resolveEntityKey: (x) => String(x).trim().toLowerCase(), loadEntityAliases: () => ({}) }
