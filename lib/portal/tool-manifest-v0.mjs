...
function inferToolLifecycle(moduleId, launchStatus) {
  if (moduleId === 'inventory' || launchStatus === 'launchable') return 'launchable';
  return 'sandbox';
}

function inferProdExposure(moduleId, launchStatus, lifecycle) {
  if (moduleId === 'inventory' && launchStatus === 'launchable') return 'public';
...
function inferDataNamespace(moduleId, lifecycle, prodExposure) {
  if (moduleId === 'inventory') return 'personal';
