...
const SECRETARY_CHAT_ENDPOINT = '/api/secretary/chat';
...
function buildRuntimeAiProviderFromEnv(providerId, env = {}) {
  ...
  return {
    ...
    startEndpoint: SECRETARY_CHAT_ENDPOINT,
...
function normalizeRuntimeAiProvider(providerId, runtimeProvider = {}) {
  return {
    ...
    startEndpoint: runtimeProvider.startEndpoint || SECRETARY_CHAT_ENDPOINT,
