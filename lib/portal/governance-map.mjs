...
export const GOVERNANCE_MAP = [
  ...
  // ---- 安全与就绪 ----
  { id: 'security-incident', title: '安全事件就绪', group: 'safety', status: 'report-only', reportKey: 'securityIncidentReadiness',
    path: 'lib/portal/security-incident-readiness-contract.mjs', governs: '事件类型/严重度/各模块就绪', consumedBy: 'report:modules' },
  { id: 'cloud-readiness', title: '云就绪', group: 'safety', status: 'report-only', reportKey: 'cloudReadiness',
    path: 'lib/portal/cloud-readiness-contract.mjs', governs: '云 provider/同步冲突/导出删除语义', consumedBy: 'report:modules' },
  { id: 'production-activation', title: '生产激活', group: 'safety', status: 'report-only', reportKey: 'productionActivation',
    path: 'lib/portal/production-activation-contract.mjs', governs: '生产开关的激活门', consumedBy: 'report:modules' },
  { id: 'standalone-readiness', title: '独立上架就绪', group: 'safety', status: 'report-only', reportKey: 'standaloneAppReadiness',
    path: 'lib/portal/standalone-app-readiness-contract.mjs', governs: '独立 app 上架就绪', consumedBy: 'report:modules' },
  ...
  { id: 'tool-data-versioning', title: '工具数据版本', group: 'lifecycle', status: 'report-only', reportKey: 'toolDataVersioning',
    path: 'lib/portal/tool-data-versioning-contract.mjs', governs: '工具数据的版本迁移', consumedBy: 'report:modules' },
  { id: 'user-identity-upgrade', title: '身份升级', group: 'lifecycle', status: 'report-only', reportKey: 'userIdentityUpgrade',
    path: 'lib/portal/user-identity-upgrade-contract.mjs', governs: '匿名→账号 的身份升级', consumedBy: 'report:modules' },
  { id: 'offline-sync-conflict', title: '离线同步冲突', group: 'lifecycle', status: 'report-only', reportKey: 'offlineSyncConflict',
    path: 'lib/portal/offline-sync-conflict-contract.mjs', governs: '离线/冲突解决策略', consumedBy: 'report:modules' },
  ...
  { id: 'module-adapter', title: '模块适配契约', group: 'external', status: 'report-only',
    path: 'lib/portal/module-adapter-contract.mjs', governs: '模块适配版本', consumedBy: 'scripts/report-module-registry.mjs' },

  // ---- 漂移观察(drifted)----
  { id: 'ai-provider-router', title: 'AI 供应商路由契约', group: 'runtime', status: 'drifted', reportKey: 'aiProviderRouter',
    ...
    note: '⚠ 漂移:真 AI 运行时 ai-complete.ts 完全不按此契约;契约说一套、代码做一套' },
];
