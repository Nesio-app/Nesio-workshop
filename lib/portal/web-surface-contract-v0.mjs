...
const PUBLIC_LAUNCH_MODULE_IDS = Object.freeze(['shell', 'inventory', 'plan']);
...
function buildWarnings(contract) {
  ...
  if (!contract.mobileWeb.mobileFirst || contract.mobileWeb.supportLevel !== 'official') {
    warnings.push({
      ...
      reason: 'Nesio v0.1 launch scope is mobile-first personal toolbox.',
      owner: 'Qiao',
...
export function buildWebSurfaceContractV0({
  ...
  const contract = {
    ...
    mobileWeb: {
      ...
      launchScope: {
        productPositioning: 'Nesio v0.1 is a mobile-first personal toolbox.',
        publicModuleIds: [...PUBLIC_LAUNCH_MODULE_IDS],
        shellRequired: true,
        inventoryPurchaseMemoryRequired: true,
        todoTaskSupportRequired: true,
      ...
      qaChecklist: [
        ...
        'Shell + Inventory / purchase-memory + Todo path',
    ...
    appPositioning: {
      launchLine: 'Nesio v0.1 is a mobile-first personal toolbox.',
