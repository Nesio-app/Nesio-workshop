...
const LAUNCHABLE_MODULE_IDS = Object.freeze(['inventory']);
const FUTURE_PAID_MODULE_IDS = Object.freeze(['plan', 'sanctuary', 'reading', 'fitness', 'quiz', 'lifesim']);
...
function inferProdExposure(tool, launchStatus, lifecycle) {
  ...
  if (launchStatus === 'launchable' && tool.id === 'inventory') return 'public';
...
function normalizeContext(context = {}) {
  const allowlist = new Set(context.testerAllowlist || []);
  return {
...
export function resolveLaunchSurfaceState(tool, context = {}) {
  ...
  if (launchStatus === 'launchable' && prodExposure === 'public') {
    visible = true;
