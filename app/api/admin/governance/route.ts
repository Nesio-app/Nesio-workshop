 ...
 *
 * 数据源(全静态,无需数据库):
 *   - lib/portal/governance-map.mjs:29 个治理面的单一来源(status/path/治理什么/消费方)
 *   - lib/portal/governance-snapshot.json:report:modules 的实时数字快照
...
import { GOVERNANCE_MAP, GOV_STATUS_META, GOV_GROUP_META, summarizeGovernance } from '@/lib/portal/governance-map.mjs';
import snapshot from '@/lib/portal/governance-snapshot.json';
