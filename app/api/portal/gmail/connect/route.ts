...
// drive.appdata=可读旧隐藏备份;drive.file=在「我的云端硬盘/宝盒备份」建可见文件(含照片)。
// tasks/contacts.readonly=敏感 scope(生产需 Google OAuth 验证审核,验证前有未验证警告与 100 用户上限)。
const GMAIL_SCOPE = 'https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/gmail.send https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/calendar.events https://www.googleapis.com/auth/drive.appdata https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/tasks https://www.googleapis.com/auth/contacts.readonly';
