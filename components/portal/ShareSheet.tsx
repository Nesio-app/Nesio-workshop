...
export default function ShareSheet({ open, onClose }: ShareSheetProps) {
  ...
  return (
    ...
    >
        ...
        {/* Analyzing */}
        {analyzing && (
          <div style={{ textAlign: 'center', padding: '1.5rem 0', color: 'var(--portal-muted)', fontSize: 'var(--text-sm)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
