      ...
      <div className="nesio-growth">
        {!applied ? (
          ...
          <>
            ...
            <p style={{ display: 'flex', alignItems: 'center', gap: 8, fontWeight: 'var(--weight-semibold)', fontSize: '0.98rem', margin: '0 0 12px', color: 'var(--portal-accent)' }}>
              <Ico path={applied.icon} cls="li" />{L(dict, applied.name, applied.nameEn)}
            </p>
